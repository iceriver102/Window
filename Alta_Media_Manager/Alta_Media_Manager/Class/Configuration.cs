...
namespace Alta_Media_Manager.Class
{
    ...
    public class Configuration
    {
        ...
        {
            if (!Directory.Exists(this.PathTmpFolder))
            {
                System.IO.Directory.CreateDirectory(this.PathTmpFolder);
            }
        }
        [NonSerialized]
        ...
        public string MySql_server="127.0.0.1";
        ...
        public string Ftp_Server = "ftp://127.0.0.1";
        ...
        public string PathTmpFolder = @"tmp";
        ...
        public Configuration LoadXML()
        {
            ...
            try
            {
                ...
                if (!Directory.Exists(tmp.PathTmpFolder))
                {
                    System.IO.Directory.CreateDirectory(tmp.PathTmpFolder);
                }
                stream.Close();
            }catch(Exception ex)
            {
        ...
        public static Configuration ByteArrayToObject(byte[] arrBytes)
        {
            ...
            if (!Directory.Exists(obj.PathTmpFolder))
            {
                System.IO.Directory.CreateDirectory(obj.PathTmpFolder);
            }
