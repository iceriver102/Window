...
namespace Alta_Media_Manager.Alta_view.Class
{
    public class alta_class_media
    {
        ...
        //        if (this != null)
        //        {
        //            if (this.alta_media_type.alta_id == 1)
        //            {
        //                return new BitmapImage(new Uri("pack://application:,,,/Alta_Media_Manager;component/Asset/Alta_Avatar/av_video_small.png"));
        //            }
        //            else
        //            {
        //                return new BitmapImage(new Uri("pack://application:,,,/Alta_Media_Manager;component/Asset/Alta_Avatar/av_camera_small.png"));
        //            }
        //        }
        //        else
        //        {
